...
<div class="wrapper">
              ...
              <div class="card-body">
                <div class="d-flex">
                  <p class="d-flex flex-column">
                    <span class="text-bold text-lg">820</span><!--puxarda do bd-->
                    <span>Clientes</span>
                  </p>
                  <p class="ml-auto d-flex flex-column text-right">
                    <span class="text-success">
                      <i class="fas fa-arrow-up"></i> 12.5% <!-- acrescimo de clientes-->
                    </span>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 AB Comunicação e Tecnologia</strong>
